...
<p float="center"> 
    Top: input mesh, Bottom: B-spline patches generated by Polyhedral splines 
...
> The single subdivision step will be applied automatically if any supported configuration is detected.

(gray: submesh / green: tensor-product splines)
<p float="left">
    <img src="img_readme/allowable_config_2.png" width="800" />
</p>
<p float="left">
    <img src="img_readme/allowable_config_1.png" width="800" />
</p>
