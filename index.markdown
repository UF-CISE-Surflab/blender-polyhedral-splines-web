...
<p float="center"> 
    ...
    (<span style="color:gray">Gray: regular Bi-2</span>, <span style="color:green">Green: extraordinary point</span>, <span style="color:cyan">Cyan: T0</span>, <span style="color:lime">Lime: T1</span>) 
</p>
