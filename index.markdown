...
<p float="center"> 
    ...
    (<span style="color:gray">Gray</span>: regular Bi-2, <span style="color:green">Green</span>: extraordinary point, <span style="color:cyan">Cyan</span>: T0, <span style="color:lime">Lime</span>: T1) 
</p>
